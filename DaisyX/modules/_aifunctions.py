...
from DaisyX import telethn, OWNER_ID
...
async def hmm(event):
  ...
  if "no no" in result:
   pro = "I am fairly young and I was made by @Mrkahno, he’s my God."
   try:
   ...
   pro = "My name is Akiro, I’m an AI robot 🤖 "
   try:
      async with telethn.action(event.chat_id, 'typing'):
           await asyncio.sleep(2)
           await event.reply(pro)
