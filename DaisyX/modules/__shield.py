...
from DaisyX.modules.sql_extended.nsfw_watch_sql import (
    add_nsfwatch,
...
__help__ = """
<b> Group Guardian: </b>
✪ Akiro can protect your group from NSFW senders, Slag word users and also can force members to use English
