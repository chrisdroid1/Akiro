...
@pbot.on_message(filters.command("vchelp") & ~filters.private)
...
@pbot.on_message(filters.command("leavevc") & ~filters.private)
...
@pbot.on_message(filters.command("volume") & ~filters.private)
...
@pbot.on_message(filters.command("skip") & ~filters.private)
...
@pbot.on_message(filters.command("play") & ~filters.private)
...
@pbot.on_message(filters.command("queue") & ~filters.private)
...
@pbot.on_message(filters.command("telegram") & ~filters.private)
...
@pbot.on_message(filters.command("listvc") & ~filters.private)
